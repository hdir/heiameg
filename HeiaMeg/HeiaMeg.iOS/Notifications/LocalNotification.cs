...
namespace HeiaMeg.iOS.Notifications
{
    public class LocalNotification
    {
        ...
        public static void Show(string title, string body, int id = 0)
        {
        ...
        public static void Show(string title, string body, int id, DateTime notifyTime, ushort badges = 1)
        {
            if (UIDevice.CurrentDevice.CheckSystemVersion(10, 0))
            {
            ...
            else
            {
                var notification = new UILocalNotification
                {
                    ...
                    AlertTitle = title,
                    AlertBody = body,
                    ApplicationIconBadgeNumber = badges,
